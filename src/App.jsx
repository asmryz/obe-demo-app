...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            { path: "overview", element: <Placeholder title="Batch Performance" /> },
            { path: "usage", element: <Placeholder title="CLO/PLO Summary" /> },
            { path: "billing", element: <Placeholder title="Audit Logs" /> },
            { path: "quickstart", element: <Placeholder title="Washington Accord Guide" /> },
            { path: "api-reference", element: <Placeholder title="HEC Policy Manual" /> },
            { path: "guides", element: <Placeholder title="CQI Best Practices" /> },
            { path: "search", element: <Placeholder title="Search Records" /> },
            { path: "news", element: <Placeholder title="OBE Policy Updates" /> },
            { path: "api-key", element: <Placeholder title="Get Faculty Token" /> },
