...
const AgentCards = ({ onOpenModal }) => {
    return (
        <div className="bg-gray-50/50 border border-dashed border-gray-300 rounded-2xl p-16 text-center flex flex-col items-center justify-center">
            ...
            <h3 className="text-2xl font-medium text-gray-900 mb-3">OBE Faculty Agents</h3>
            <p className="text-gray-600 max-w-sm mb-8 leading-relaxed">
                Build and deploy specialized OBE agents that can analyze course folders, calculate attainment metrics, and generate quality improvement comments.
            </p>
            <button
                onClick={onOpenModal}
